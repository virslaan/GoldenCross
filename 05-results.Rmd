...
```{r}
lineChart(AAPL1, line.type = 'h', subset = '2019-01::', theme = chartTheme('white'), up.col = '#1AA36D')
```
...
```{r}
lineChart(GM1, line.type = 'h', subset = '2019-01::', theme = chartTheme('white'), up.col = '#1AA36D')
```
...
```{r}
lineChart(TSLA1, line.type = 'h', subset = '2019-01::', theme = chartTheme('white'), up.col = '#1AA36D')
```
...
```{r}
lineChart(MSFT1, line.type = 'h', subset = '2019-01::', theme = chartTheme('white'), up.col = 'sky blue')
```
...
```{r}
lineChart(COST1, line.type = 'h', subset = '2019-01::',theme = chartTheme('white'), up.col = '#1AA36D')
```
...
```{r}
lineChart(NVDA1, line.type = 'h', subset = '2019-01::', theme = chartTheme('white'), up.col = '#1AA36D')
```
