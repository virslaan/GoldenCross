...
author: "Zhaoyu Wu, Vipul H Harihar, Zhirui Yang"
date: "`r Sys.Date()`"
...
**Vipul H Harihar** (worked in-person) mananged and took care of the entire GitHub script management and book rendering, and text composition of the entire chapters. He worked on the D3 interactive plots and enhanced the data visualizations and color schemes as required by the industry. He included all the resources and marked and wrote the chapters subsequentially in the complete project. He took active efforts to make this project to reach its completion by giving and showing it on time to the respected professor and TAs for suggestions and improvements.

**Zhaoyu Wu** (worked remotely) suggested the project topic and worked on data visualizations and text composition. He created interactive candlestick plots and other static data visualizations using plotly.js and also wrote their interpretations.

**Zhirui Yang** (worked remotely) worked on active data collection, data cleaning and preprocessing which became foundation of the other interactive plots made by the users.
