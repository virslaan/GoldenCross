...
```{r}
lineChart(AAPL1, line.type = 'h', subset = '2019-01::', theme = chartTheme('white'), up.col = 'sky blue')
```
...
```{r}
lineChart(GM1, line.type = 'h', subset = '2019-01::', theme = 'white')
```
...
```{r}
lineChart(TSLA1, line.type = 'h', subset = '2019-01::', theme = 'white')
```
...
```{r}
lineChart(MSFT1, line.type = 'h', subset = '2019-01::', theme="white")
```
...
```{r}
lineChart(COST1, line.type = 'h', subset = '2019-01::',theme='white')
```
...
```{r}
lineChart(NVDA1, line.type = 'h', subset = '2019-01::', theme = 'white')
```
