...
Zhaoyu Wu chose the topic of the project and is responsible for data visualization and text composition. He created interactive candlestick plots and other static data visualization and interpretations. Vipul Harihar worked on GitHub script managing, book rendering, and text composition. He also contributed to the D3 interactive line plot. Zhirui Yang worked on data cleaning and preprocessing.
